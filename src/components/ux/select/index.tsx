...
import { createContext, useContext, useState, useRef, useEffect, useCallback, useMemo, memo } from "react"
...
export const Select = memo(function Select({
  ...
  const handleValueChange = useCallback(
    ...
    [value, onValueChange, multiple, handleOpenChange],
  )
  ...
  const contextValue = useMemo(
    ...
    [currentValue, handleValueChange, open, handleOpenChange, multiple, selectedLabels, setSelectedLabel],
  )
...
export const SelectContent = memo(function SelectContent({ children }: SelectContentProps) {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div ref={contentRef} className="select-content" {...motionProps} role="listbox">
          {children}
        </motion.div>
      )}
    </AnimatePresence>
